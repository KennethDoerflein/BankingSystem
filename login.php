  ...
  <div id="log-in">
    ...
    <form action='scripts/login_confirm.php' method='post'>
      <div class="log-in">
        ...
        <p>
          <center>Please enter your username and password:</center>
        </p>
        <div>
          <!--input for username-->
